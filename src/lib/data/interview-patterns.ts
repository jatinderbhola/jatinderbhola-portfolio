...
while (left < right) {
    ...
    if (condition) {
		...
		exampleProblems: ['Two Sum (sorted array)', 'Container With Most Water', 'Valid Palindrome']
	},
	{
		id: 'sliding-window',
...
while (fast && fast.next) {
    ...
    if (slow === fast) {
		...
		exampleProblems: ['Linked List Cycle', 'Find Middle of Linked List', 'Palindrome Linked List']
	},
	{
		id: 'tree-traversal',
...
while (left <= right) {
    ...
    if (arr[mid] === target) {
		...
		exampleProblems: ['Search in Rotated Sorted Array', 'Find Peak Element', 'Search a 2D Matrix']
	},
	{
...
return dp[n];`,
		...
		exampleProblems: ['Climbing Stairs', 'House Robber', 'Longest Common Subsequence']
	},
	{
		id: 'backtracking',
		title: 'Backtracking',
    ...
    for (let choice of choices) {
		...
		exampleProblems: ['Subsets', 'Permutations', 'N-Queens']
	},
	{
		id: 'hashmap-hashset',
...
for (let i = 0; i < arr.length; i++) {
    ...
    seen.set(arr[i], i);
		...
		exampleProblems: ['Two Sum', 'Group Anagrams', 'Valid Anagram']
	}
];
	...
	},
	{
		...
		problems: [
			...
			},
			{
				...
				description: 'Find smallest window containing all chars'
			},
			{
				name: 'Longest Repeating Character Replacement',
				description: 'Max length with k replacements'
			},
			{ name: 'Permutation in String', description: 'Check if s2 contains permutation of s1' },
			{
				name: 'Fruit Into Baskets',
				description: 'Max fruits with 2 types (subarray with 2 distinct)'
			}
		]
	}
];

...
<svelte:head>
  ...
  <meta property="og:image" content={$resume.personalInfo.avatar} />

  <!-- Twitter -->
  <meta property="twitter:card" content="summary_large_image" />
  <meta property="twitter:url" content={$page.url.href} />
  <meta property="twitter:title" content={$resume.personalInfo.name} />
  <meta property="twitter:description" content={$resume.summary} />
  <meta property="twitter:image" content={$resume.personalInfo.avatar} />
...
<div class="space-y-8">
  ...
  <section>
    <h2 class="text-2xl font-bold text-gray-900 mb-4">{t('sections.professionalSummary')}</h2>
    <ProfessionalSummary />
  </section>

  <section>
    <h2 class="text-2xl font-bold text-gray-900 mb-4">{t('sections.latestAiProduct')}</h2>
    <LatestAiProduct />
  </section>

  <section>
    <h2 class="text-2xl font-bold text-gray-900 mb-4">{t('sections.experience')}</h2>
    <Experience />
  </section>

  <section>
    <h2 class="text-2xl font-bold text-gray-900 mb-4">{t('sections.education')}</h2>
    <Education />
  </section>

  <section>
    <h2 class="text-2xl font-bold text-gray-900 mb-4">{t('sections.impactSummary')}</h2>
    <ImpactSummary />
  </section>
</div>
